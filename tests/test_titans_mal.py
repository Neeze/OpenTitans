...
from open_titans.models.titans_mal.configuration_mal import TitansMALConfig
from open_titans.models.titans_mal.modeling_mal import TitansMALModel
...
def test_titans_mal():
    ...
    print("Instantiating MAL model...")
    model = TitansMALModel(config, neural_memory_model=neural_memory_model)
